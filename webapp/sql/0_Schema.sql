...
alter table isu_condition add index mix_index_jia_isu_uuid(jia_isu_uuid,timestamp);
alter table isu add index idx_character (`character`);
alter table isu add index idx_jia_user_id_jia_isu_uuid (`jia_user_id`, `jia_isu_uuid`);
